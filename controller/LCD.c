...
uint16_t scc[11] = {0x1551, 0x0110, 0x1E11, 0x1B11, 0x0B50, 0x1B41, 0x1F41, 0x0111, 0x1F51, 0x1B51, 0x0000};
...
void writeChar(char ch, int pos){
	if(pos>=0 && pos<=5){
		uint8_t index = (ch != 11) ? (uint8_t)ch-48 : 10; //izza hack
		uint8_t even = 0x00;
...
void clear(int pos) {
	writeChar(11, pos); //dummy char acutally 0x0000
}
